                ...
                <div className="d-flex gap-3 align-items-center justify-content-end">
                  <form>
                    <Col className="input-group justify-content-end " size="sm">
                      ...
                      <Button
                        size="sm"
                        className="rechargeshipment btn-info "
                        type="search"
                      >
                        <IoSearchSharp />
                      </Button>
                  ...
                  <div>
                    <Col className="input-group d-flex justify-content-start ">
                      <Button
                        variant="lighgt"
                        className="rechargeshipment btn-info btn-sm"
                        onClick={() => handleShow()}
                      >
                        <BiRupee /> Recharge
                      </Button>
                      <Button variant="lighgt" className="border btn-sm">
                        Balance <BiRupee /> 0
                      </Button>
                    </Col>
                  ...
                  <Dropdown>
                    <Dropdown.Toggle
                      variant="info"
                      size="sm"
                      className="rechargeshipment"
                    >
                      Unknown
                    </Dropdown.Toggle>
                    <Dropdown.Menu>
                      <Dropdown.Item as={Link} to="/Settings/company-profile">
                        Profile
                      </Dropdown.Item>
                      <Dropdown.Item
                        as={Link}
                        to="/Settings/AccountSettingDetails"
                      >
                        Settings
                      </Dropdown.Item>
