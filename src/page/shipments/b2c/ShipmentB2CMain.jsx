...
export default function ShipmentB2cMain() {
                            ...
                            <Col className="border bg-white mt-5 rounded" >
                                <Row className="w-100 d-flex justify-content-between align-items-start  p-3 ">
                                    ...
                                    <Col md={4} className="d-flex gap-2 justify-content-end " >
                                        ...
                                        <Button variant="light" className="btn-outline-dark btn-sm" onClick={() => navigate('/shipment-b2c/manifest-b2c')}><FaPrint size={12} /> Manifest</Button>
