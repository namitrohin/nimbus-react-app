...
export default function ShipmentDocument() {
                                ...
                                <Col>
                                    <Row className="w-100 d-flex justify-content-between align-items-start  p-2 ">
                                        ...
                                        <Col md={4} className="d-flex gap-2 justify-content-end " >
                                            ...
                                            <Button variant="light" className="btn-outline-dark btn-sm" onClick={() => navigate('')}><FaPrint size={12} /> Manifest</Button>
                                    ...
                                    {showForm && (
                                        <Form>
                                            ...
                                            <Row>
                                                ...
                                                <Col md={2}>
                                                    <Form.Label>Shipment Tag (s)</Form.Label>
                                                    <Form.Control
                                                        size="sm"
                                                        type="text"
                                                        name=""
                                        ...
                                        <Row>
                                            <Col className="">
                                                <div className="d-flex gap-5 mb-3 md-2 ">
                                                    <Button variant="light" size="sm" className={`  shadow  ${selected === 'All' ? 'active' : 'bg-dark'}`} onClick={() => handleSelect('All')}>All </Button>
