                                ...
                                <Col>
                                    <Row className="w-100 d-flex justify-content-between align-items-start  p-2 ">
                                        ...
                                        <Col md={4} className="d-flex gap-2 justify-content-end " >
                                            ...
                                            <Button variant="light" className="btn-outline-dark btn-sm" onClick={() => navigate('')}> Weight SOP</Button>
                                        ...
                                        <Row>
                                            <Col className="">
                                                <div className="d-flex gap-5 mb-3 md-2">
                                                    ...
                                                    <Button variant="light" size="sm" className={` shadow pe-3 px-3  ${selected === 'Accepted' ? 'active' : ''}`} onClick={() => handleSelect('Accepted')}>Accepted</Button>
                                                    <Button variant="light" size="sm" className={` shadow pe-3 px-3 ${selected === 'Open Disputes' ? 'active' : ''}`} onClick={() => handleSelect('Open Disputes')}>Open Disputes</Button>
                                                    <Button variant="light" size="sm" className={` shadow  pe-3 px-3 ${selected === 'Close Disputes' ? 'active' : ''}`} onClick={() => handleSelect('Close Disputes')}>Close Disputes</Button>
